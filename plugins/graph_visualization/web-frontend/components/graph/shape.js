...
export const ProjectNode = Graph.registerNode('project-node', {
  ...
  attrs: {
    ...
    nodeImage: {
      'xlink:href': 'https://api.iconify.design/mdi-crane.svg',
    },
    title: {
      text: 'Project Title',
    },
...
export const FunctionNode = Graph.registerNode('function-node', {
  ...
  attrs: {
    ...
    nodeImage: {
      'xlink:href': 'https://api.iconify.design/mdi-function.svg',
    },
    title: {
      text: 'Function Title',
    },
...
export const DeviceNode = Graph.registerNode('device-node', {
  ...
  attrs: {
    ...
    nodeImage: {
      'xlink:href': 'https://api.iconify.design/mdi-chip.svg',
    },
    title: {
      text: 'Device Title',
    },
...
export const ResourceNode = Graph.registerNode('resource-node', {
  ...
  attrs: {
    ...
    nodeImage: {
      'xlink:href': 'https://api.iconify.design/emojione-monotone:letter-r.svg',
    },
    title: {
      text: 'Resource Title',
    },
...
export const PeopleNode = Graph.registerNode('people-node', {
  ...
  attrs: {
    ...
    nodeImage: {
      'xlink:href': 'https://api.iconify.design/akar-icons:person.svg',
    },
    title: {
      text: 'People Title',
    },
